...
class CocoDataset(data.Dataset):
  ...
  def __init__(self, root, json, batched_captions, vocab, transform=None):
...
def collate_fn(data):
  ...
  return images[0], captions[0], lengths[0]


def get_loader(root, json, batched_captions, vocab, transform, batch_size, shuffle, num_workers):
